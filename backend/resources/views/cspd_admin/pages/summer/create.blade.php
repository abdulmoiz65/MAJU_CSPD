    ...
    <div class="container-fluid pt-4 px-4">
        <div class="form-container">
            <div class="form-header">
                <h2><i class="fas fa-sun me-2"></i>Add Summer School</h2>
                <p class="text-muted mb-0">Fill in the details for the new summer school program</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.summer.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="btn-form-group">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-2"></i>Save Summer School
                    </button>
