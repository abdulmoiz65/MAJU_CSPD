    ...
    <div class="container-fluid pt-4 px-4">
        <div class="form-container">
            <div class="form-header">
                <h2><i class="fas fa-edit me-2"></i>Edit Diploma Program</h2>
            ...
            <form method="POST" action="{{ route('admin.diploma.update', $program->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="duration" value="{{ old('duration', $program->duration) }}"
                                class="form-control @error('duration') is-invalid @enderror" placeholder="e.g., 6 Months">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="total_hours" value="{{ old('total_hours', $program->total_hours) }}"
                                class="form-control @error('total_hours') is-invalid @enderror" placeholder="e.g., 200 Hours">
                        ...
                        <div class="form-group">
                            <label class="form-label"><i class="fas fa-money-bill-wave me-1"></i> Program Fees (PKR)</label>
                            <input type="number" name="fees" step="0.01" value="{{ old('fees', $program->fees) }}"
                                class="form-control @error('fees') is-invalid @enderror" placeholder="e.g., 50000">
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        ...
                        <p class="text-muted">Set the important dates for the program timeline</p>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
