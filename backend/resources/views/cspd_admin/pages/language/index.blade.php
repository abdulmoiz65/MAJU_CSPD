    ...
    <div class="container-fluid pt-4 px-4">
        <div class="table-container">
            <div class="table-header">
                <div>
                    <h2><i class="fas fa-language me-2"></i>Language Courses</h2>
                    <p class="text-muted mb-0">Manage all language courses</p>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('admin.language.edit', $program->id) }}"
                                            class="btn btn-sm btn-warning" data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="Edit Course">
                                            <i class="fas fa-edit"></i>
                                        </a>

                                        <form action="{{ route('admin.language.destroy', $program->id) }}" method="POST"
                                            class="d-inline"
                                            onsubmit="return confirm('Are you sure you want to delete this course?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-sm btn-danger" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Delete Course">
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-5">
                                    <div class="empty-state">
                                        ...
                                        <h5>No Language Courses Found</h5>
                                        <p class="text-muted">Get started by creating your first language course.</p>
                                        <a href="{{ route('admin.language.create') }}" class="btn btn-primary">
