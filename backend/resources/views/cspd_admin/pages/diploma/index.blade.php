    ...
    <div class="container-fluid pt-4 px-4">
        <div class="table-container">
            <div class="table-header">
                <div>
                    <h2><i class="fas fa-graduation-cap me-2"></i>Diploma Programs</h2>
                    <p class="text-muted mb-0">Manage all diploma programs</p>
                </div>
                <a href="{{ route('admin.diploma.create') }}" class="btn btn-primary">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="mb-1">
                                        ...
                                        <strong>{{ $program->display_date ?? 'N/A' }}</strong>
                                    </div>
                                    <div class="text-muted">
                                        <i class="fas fa-clock me-1"></i>
                                        {{ $program->duration ?? 'N/A' }} | {{ $program->total_hours ?? 'N/A' }}
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('admin.diploma.edit', $program->id) }}"
                                            class="btn btn-sm btn-warning" data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="Edit Program">
                                            <i class="fas fa-edit"></i>
                                        </a>

                                        <form action="{{ route('admin.diploma.destroy', $program->id) }}" method="POST"
                                            class="d-inline"
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-5">
                                    <div class="empty-state">
                                        ...
                                        <h5>No Diploma Programs Found</h5>
                                        <p class="text-muted">Get started by creating your first diploma program.</p>
                                        <a href="{{ route('admin.diploma.create') }}" class="btn btn-primary">
