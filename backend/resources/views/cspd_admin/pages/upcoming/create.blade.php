            ...
            <form method="POST" action="{{ route('admin.upcoming.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <!-- Enroll Link (Optional) -->
                        <div class="form-group">
                            <label class="form-label">
                                <i class="fas fa-link me-1"></i> Enroll Link
                            </label>
                            <input type="url" name="enroll_link"
                                value="{{ old('enroll_link', 'https://docs.google.com/forms/d/e/1FAIpQLSdWrXKQl_OMKYznN8sUVK7SYjP6VTQ-_AHhhI2eKKUUxKWWVw/viewform') }}"
                                class="form-control @error('enroll_link') is-invalid @enderror"
                                placeholder="Enter enrollment URL">
                            <small class="text-muted">Default link will be used if left empty</small>
                            @error('enroll_link')
                                <span class="error-feedback">{{ $message }}</span>
                            @enderror
                        </div>
